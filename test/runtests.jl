...
# !!! Main.UserApp is configured as an alias for Main.Lab1 and you might encounter it in some tests
using Main.Lab1, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Lab1 tests" begin
  @includetests ARGS
end
